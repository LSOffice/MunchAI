          ...
          <div>
            {Object.keys(groupedMealPlan).length > 0 ? (
              <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {entries.map((entry) => (
                        <div
                          key={entry.id}
                          className="flex items-start justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-700/50"
                        >
                          <div>
                            ...
                            <Link
                              ...
                              className="mt-1 text-lg font-semibold text-gray-900 hover:text-orange-600 dark:text-white dark:hover:text-orange-400"
                            >
                              {entry.recipe.title}
                            </Link>
                ...
                <button className="w-full rounded-lg border-2 border-dashed border-gray-300 py-6 text-center transition-all hover:border-orange-500 hover:bg-orange-50 dark:border-gray-700 dark:hover:bg-orange-900/10">
