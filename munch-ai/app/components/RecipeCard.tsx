    ...
    <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
      ...
      {recipe.imageUrl && (
        <div className="relative h-48 w-full overflow-hidden bg-gray-100 dark:bg-gray-800">
          ...
          />
          <div className="absolute right-2 top-2 rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-gray-900 dark:bg-gray-900/90 dark:text-white">
            {recipe.difficulty}
          </div>
        </div>
      )}
      ...
      <div className="p-4">
        <Link href={`/recipes/${recipe.id}`}>
          <h3 className="mb-2 text-lg font-semibold text-gray-900 hover:text-orange-600 dark:text-white dark:hover:text-orange-400">
            {recipe.title}
          </h3>
        </Link>
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-3 dark:border-gray-800">
          ...
          <div className="flex gap-2">
            ...
            <Link
              ...
              className="rounded bg-orange-500 px-2 py-1 text-xs font-medium text-white transition-colors hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700"
            >
              View
            </Link>
          </div>
